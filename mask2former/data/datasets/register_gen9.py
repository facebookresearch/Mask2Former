...
## FULL DS
PATH_IMAGES = os.path.expanduser("~/data/ril-digitaltwin/gen9/generatorv9")
PATH_IMAGES_SHAPENET = os.path.expanduser("~/data/ril-digitaltwin/gen9/generatorv9_shapenetv1")
PATH_PANOPT = os.path.expanduser("~/data/ril-digitaltwin/gen9/generatorv9_panoptic")
# PATH_SEMSEG = PATH_PANOPT  # FIXME this is wrong but inconsequential
DATA_JSON = os.path.join(PATH_PANOPT, "00000_dsinfo.json")

DATASET_NAME_RAW = "rilv9"
DATASET_NAME_SHN = "rilv9-shapenetv1"
DATASET_NAME_TEST = "rilv9-test"
TEST_SPLIT = 0.1  # 10 %
...
data_train_raw = replace_paths(data_json, PATH_IMAGES, PATH_PANOPT, metadata, 0, len_train)
data_train_shapenet = replace_paths(dj_shn, PATH_IMAGES_SHAPENET, PATH_PANOPT, metadata, 0, len_train)
...
MetadataCatalog.get(DATASET_NAME_RAW).set(panoptic_json=data_json_train_path, **full_metadata)
MetadataCatalog.get(DATASET_NAME_SHN).set(panoptic_json=data_json_train_path, **full_metadata)
